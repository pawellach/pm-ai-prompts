# generate-status-report — Atlassian Claude Code skill
...
>
> To use as a skill in your own project, copy this file to `.claude/skills/generate-status-report/SKILL.md`.
> The skill activates via `/generate-status-report` command in Claude Code.
