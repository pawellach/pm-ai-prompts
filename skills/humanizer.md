...
> This is a Claude Code skill file. Place it in `.claude/skills/humanizer/SKILL.md` in your project to activate it.
> Source: MIT-licensed, based on Wikipedia's [Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing).
