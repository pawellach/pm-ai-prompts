# capture-tasks-from-meeting-notes — Atlassian Claude Code skill
...
>
> To use as a skill in your own project, copy this file to `.claude/skills/capture-tasks-from-meeting-notes/SKILL.md`.
> The skill activates via `/capture-tasks-from-meeting-notes` command in Claude Code.
